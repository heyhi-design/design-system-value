...
`scripts/check-no-internal-refs.sh` scans the repository for references that should never appear in a generic release. Run it before publishing any change:
